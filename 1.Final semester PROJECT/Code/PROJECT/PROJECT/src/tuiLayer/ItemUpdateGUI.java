...
public class ItemUpdateGUI {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ItemUpdateGUI window = new ItemUpdateGUI();
	...
	private void initialize() {
		...
		txtNoOfItems.setText("Number of items");
		...
		btnUpdate.setBounds(37, 365, 149, 31);
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					int price = Integer.parseInt(txtPrice.getText());
						...
						itemCtr.updateItem(barcode, noInStock, name,
								description, type, minimumNo, maximumNo, price);
						JOptionPane.showMessageDialog(null,
								"Item succesefully updated!", "Item updater",
